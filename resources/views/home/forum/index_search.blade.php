            ...
            <div class="layui-col-md9">
                <div class="fly-panel" style="margin-bottom: 0; border-bottom: 1px solid #e2e2e2; box-shadow: 0 2px 3px rgba(0,0,0,.1); border-radius:6px;">
                    ...
                    <div class="fly-panel-title fly-filter" style=" border-bottom: 1px solid #EBEBEB; height: auto" id="col_div">
                        <a href="/" onclick="colSelected(this)" style="padding: 0px"><div class="col col_selected ">全部</div></a>
                        @foreach ($cols as $col)
                            <a href="/colIndex?column_id={{ $col->id }}" onclick="colSelected(this)" style="padding: 0px"><div class="col">{{ $col->column_name }}</div></a>
                        @endforeach
                    ...
                    <ul class="lr flow-default fly-list" id="#flow_list"></ul>
